        ...
        <div id="myPrint">
          <div v-if="type === 'personal'">
            ...
            <table cellspacing="0" width="100%" class="tableList">
              ...
              <tr>
                <th>出生日期</th>
                <td colspan="6">{{ formData.dateOfBirth | timeFormatter }}</td>
              </tr>
              <tr>
                <th>最高学历</th>
...
<script>
import { getPersonalDetailAPI, getJobDetailAPI } from '@/api'
import { getUserBaseInfoAPI } from '@/api'
...
export default {
  ...
  methods: {
    ...
    async getJobDetail() {
      const userInfo = await getUserBaseInfoAPI(this.userId)
